...
/**
 * A simple paint panel contains white drawing surface where the user can draw
 * curves and a color palate that the user can click to select the color to be
 * used for drawing.
 */
public class PanelPaint extends JPanel {
	...
	/**
	 * Constructor for PanelPaint class sets the background color to be white
	...
	/**
	 * Draw the contents of the panel. Since no information is saved about what
	 * the user has drawn, the user's drawing is erased whenever this routine is
	 * called.
	 */
	@Override
	...
	private class MouseHandler extends MouseAdapter {
		 ...
		 * mouse location to the current mouse location, and set up X and Y for
		 * the next call.
		 */
		@Override
		public void mouseDragged(MouseEvent e) {
			Point newPoint = new Point(e.getX(), e.getY(), activeColor,
					activeSize, pen, brush);
