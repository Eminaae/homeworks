...
su 
append(object o) dodaje 
object.toString() na kraj niza charova 
prepend(object o) dodaje 
object.toString() na pocetak niza charova 
toString(object o) pretvara 
niz charova u string. 
